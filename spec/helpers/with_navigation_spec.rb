  ...
  describe '#next_button' do
    context 'with exercises' do
      ...
      context 'when user did not submit any solution' do
        it { expect(next_button(exercise_1)).to eq "<a class=\"btn btn-success btn-block\" href=\"/test/exercises/12-exercise-2\">Next: exercise 2 <i class=\"fa fa-chevron-right\"></i></a>" }
        it { expect(next_button(exercise_2)).to eq "<a class=\"btn btn-success btn-block\" href=\"/test/exercises/13-exercise-3\">Next: exercise 3 <i class=\"fa fa-chevron-right\"></i></a>" }
        it { expect(next_button(exercise_3)).to eq "<a class=\"btn btn-warning btn-block\" href=\"/test/exercises/11-exercise-1\">Next pending: exercise 1 <i class=\"fa fa-chevron-right\"></i></a>" }
      end
      ...
      context 'when on last unresolved exercise' do
        ...
        it { expect(next_button(exercise_3)).to eq "<a class=\"btn btn-warning btn-block\" href=\"/test/exercises/12-exercise-2\">Next pending: exercise 2 <i class=\"fa fa-chevron-right\"></i></a>" }
      end
    ...
    context 'with guides' do
      ...
      context 'when guide has one suggestion' do
        ...
        it { expect(next_button(lesson)).to include "<a class=\"btn btn-success btn-block\" href=\"/test/lessons/#{suggested_lesson.friendly_name}\">Next: #{suggested_lesson.name} <i class=\"fa fa-chevron-right\"></i></a>" }
      end
      ...
      context 'when guide has many suggestions' do
        ...
        it { expect(next_button(lesson)).to include "<a class=\"btn btn-success btn-block\" href=\"/test/lessons/#{suggested_lesson_1.friendly_name}\">Next: #{suggested_lesson_1.name} <i class=\"fa fa-chevron-right\"></i></a>" }
